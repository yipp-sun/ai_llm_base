...
# [{'name': 'weather_tool', 'args': {'weather': '晴朗的'}, 'id': 'call_9t3QHLfYXw6ORa1sieiR1RFJ', 'type': 'tool_call'}, {'name': 'weather_tool', 'args': {'weather': '下雪的'}, 'id': 'call_MCqurDgoiSbKk2MUATQXOeRF', 'type': 'tool_call'}]